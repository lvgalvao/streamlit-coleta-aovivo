...
def example_function(a, b):  # Falta espaço após a vírgula
    ...
    print(
        "Esta é uma linha de código que é muito longa e ultrapassa o limite de 79 \
          caracteres, o que não está de acordo com o PEP8."
    )
    result = 1 + 2  # Quebra de linha desnecessária (W503)
...
def function_with_no_space_in_def(
    param1, param2
):  # Falta de espaço após a vírgula (E231)
...
def incorrect_default_argument(
    value=[],
):  # Uso de lista mutável como valor padrão (B006)
    value.append(1)
    return value
